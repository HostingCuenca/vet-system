...
const navigation: NavItem[] = [
  ...
  { name: 'Servicios', href: '/dashboard/services', icon: '⚕️', roles: ['ADMIN'] },
  { name: 'Recordatorios', href: '/dashboard/reminders', icon: '🔔', roles: ['ADMIN', 'VETERINARIAN', 'RECEPTIONIST'] },
  { name: 'Ventas', href: '/dashboard/sales', icon: '🛒', roles: ['ADMIN', 'RECEPTIONIST'] },
  { name: 'Transacciones', href: '/dashboard/transactions', icon: '📊', roles: ['ADMIN', 'RECEPTIONIST'] },
